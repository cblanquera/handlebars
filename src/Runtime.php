...
class Runtime
{
     ...
     * @param Data|null $data If provided we will bind the callback with Data
     *
     * @return Closure|null
     */
    public static function getHelper($name, Data $data = null)
    {
     ...
     *
     * @param Data|null $bind If provided we will bind the callbacks with Data
     *
     * @return array
     */
    public static function getHelpers(Data $data = null)
    {
        if (is_null($data)) {
            return self::$helpers;
        }
